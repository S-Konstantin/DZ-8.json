def read_files():
    ...
    tree = ET.parse("/Users/konstantinsealov/Desktop/Python/HomeWork-DZ-8/py-homework-basic-files/newsafr.xml", parser)
    root = tree.getroot()
    data = root.findall("channel/item/description")
    original_text = ''
    for items in data:
        original_text += items.text
